...
resource "aws_drs_replication_configuration_template" "liberty-edr-lab-replication_configuration_template-ohio" {
    provider = aws.useast2
    staging_area_tags = {
        "Environment" = "PROD-DRS"
    }
    ...
    staging_area_subnet_id                  = aws_subnet.liberty-edr-lab-subnet-public1-us-east-2a.id
